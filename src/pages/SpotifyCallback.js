...
const SpotifyCallback = () => {
 ...
 useEffect(() => {
  ...
  try {
    ...
    const response = await axios.post('https://choco-flax.vercel.app/src/api/token', { code });
    //const response = await axios.post('https://choco-flax.vercel.app/api/token', { code });
